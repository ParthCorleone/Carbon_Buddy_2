...
const TrackDailyIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-6 h-6 mx-auto">
...
export default function AuthPage() {
    ...
    return (
        <div className="min-h-screen bg-white lg:grid lg:grid-cols-2">
            {/* Left Side */}
            <div className="hidden lg:flex flex-col justify-between relative bg-cover bg-center" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1594751543129-670a64e25967?q=80&w=3387&auto=format&fit=crop')" }}>
                ...
                <div className="w-full max-w-md space-y-8">
                    ...
                    <div className="flex justify-center p-1 bg-gray-100 rounded-full">
                        <button
                            ...
                            className={`w-1/2 py-2.5 text-sm font-semibold rounded-full transition-colors ${!isSignUp ? 'bg-white text-green-700 shadow' : 'text-gray-500 hover:bg-gray-200'}`}
                        >
                            Sign In
                        </button>
                        <button
                    ...
                    <div className="bg-white p-8 rounded-2xl border border-gray-200">
                        <div className="text-center mb-6">
                            <h2 className="text-xl font-semibold text-gray-800">{isSignUp ? 'Join the movement' : 'Welcome back'}</h2>
                            <p className="text-sm text-gray-500 mt-1">{isSignUp ? 'Start reducing your carbon footprint today' : 'Continue tracking your environmental impact'}</p>
                        </div>
